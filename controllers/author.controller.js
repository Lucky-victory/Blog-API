...
const getArticlesByAuthor=async(req,res)=>{
 ...
 const recordCountQuery=`SELECT count(a.pid) as recordCount FROM BlogSchema2.Articles as a INNER JOIN BlogSchema2.Users as u ON a.authorId=u.uid WHERE a.status='published' AND u.username='${author}'`;
