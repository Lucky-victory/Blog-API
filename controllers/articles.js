...
const createNewArticle=asyncHandler( async(req,res)=>{
   try{
      ...
      const {publishedAt=currentDate,heroImage='https://images.pexels.com/photos/4458/cup-mug-desk-office.jpg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940',title,content,tags, }=req.body;
